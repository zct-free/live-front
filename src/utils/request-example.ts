 ...
 * @FilePath: \vue3-admin\src\utils\request-example.ts
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
// 使用 AbortController 的示例

import { get, post, requestManager, createCancellableRequest } from './request';

// 示例 1: 使用便捷方法发送可取消的请求
export const fetchUserData = () => {
  const { request, cancel, requestId } = get<any>('/api/user');
