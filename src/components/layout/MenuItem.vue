<template>
	<!-- 没有子菜单的情况 -->
	<a-menu-item v-if="!hasChildren" :key="`menu-${route.name?.toString() || route.path}`">
		<router-link :to="getRoutePath()">
			<!-- <component v-if="route.meta?.icon" :is="icons[route.meta.icon as string] || icons.HomeOutlined" /> -->
